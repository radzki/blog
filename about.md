...
- Published research on [mobile testing infrastructure on clouds](https://ieeexplore.ieee.org/abstract/document/7912641/)
- Big fan of RE on IoT devices and protocol decoding
- Worked on cloud-based genetic design tools at Asimov

## $ cat contact.txt

- **GitHub**: [radzki](https://github.com/radzki)
- **LinkedIn**: [gabrielradzki](https://www.linkedin.com/in/gabrielradzki)
- **Email**: gabriel@radzkitech.com
